...
def test_pass():
    ...
    print(f"✅ Test 1 passed — date_bucket: {result['date_bucket']}")
...
def test_fail_condition_3():
    ...
    print(f"✅ Test 2 passed — rejected at condition 3: {result['rejection_reason']}")
...
def test_fail_condition_6():
    ...
    print(f"✅ Test 3 passed — rejected at condition 6: {result['rejection_reason']}")
